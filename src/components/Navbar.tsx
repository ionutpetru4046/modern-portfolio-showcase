          ...
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-1">
              ...
              <motion.button
                ...
                className="ml-4 px-5 py-2 bg-primary text-primary-foreground text-sm font-medium rounded-full hover:glow-primary transition-all duration-300 hover:scale-105"
              >
                Let's Talk
              </motion.button>
            </div>
